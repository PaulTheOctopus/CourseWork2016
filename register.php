...
<tr>
<td><input type="text" name="uname" placeholder="Логин" required /></td>
</tr>
<tr>
...
<tr>
<td><input type="text" name="address" placeholder="Адресс" required /></td>
</tr>
<tr>
<td><input type="tel" name="phone" placeholder="Номер телефона" required /></td>
</tr>
<tr>
<td><button type="submit" name="btn-signup">Зарегистрироваться</button></td>
</tr>
<tr>
